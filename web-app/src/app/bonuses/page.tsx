...
const BonusPage = () => {
    ...
    const analyzePerformance = async (empId: number) => {
        try {
            ...
            // Auto-suggest bonus amount based on score
            // 90+: 5000, 75+: 3000, 60+: 1000
    ...
    return (
        <div className="p-8 bg-slate-50 min-h-screen text-slate-800 font-sans">
            ...
            <div className="mb-12 flex items-center justify-between">
                <div>
                    <h1 className="text-5xl font-black tracking-tighter text-slate-800 uppercase">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Side Control Panel (Manager / Admin Only) */}
                {(isManager || isAdmin) && (
                    <div className="lg:col-span-1 space-y-6">
                        <Card className="rounded-[40px] border-slate-100 bg-white shadow-2xl overflow-hidden relative group">
                            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-indigo-600 to-blue-600"></div>
                            <CardHeader className="pt-10 pb-4">
                                <CardTitle className="text-lg font-black uppercase tracking-widest text-slate-800 flex items-center justify-between gap-3">
                            ...
                            <CardContent className="space-y-6 pb-10">
                                <div>
                                    ...
                                    >
                                        ...
                                        {employees.map(emp => (
                                            <option key={emp.id} value={emp.id}>{emp.display_name} - {emp.employee_code}</option>
                                        ))}
                                    </select>
                                </div>
                                    ...
                                    <div className="bg-indigo-600/5 rounded-3xl p-6 border border-indigo-600/10 space-y-4 animate-in fade-in zoom-in duration-300">
                                        ...
                                        <div className="space-y-4 pt-2">
                                            ...
                                            <Button 
                                                ...
                                                className="w-full bg-indigo-600 hover:bg-indigo-500 text-white border-none py-6 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-indigo-600/20 active:scale-95 transition-all"
                                            >
                                                Authorize Bonus
                                            </Button>
                                        </div>
                ...
                <div className={(isManager || isAdmin) ? "lg:col-span-2 space-y-6" : "lg:col-span-3 space-y-6"}>
                    <Card className="rounded-[40px] border-slate-100 bg-white shadow-2xl overflow-hidden relative">
                        <CardHeader className="pt-10 pb-6 px-10 flex flex-row items-center justify-between">
                            ...
                            <div className="flex bg-slate-50 p-1 rounded-2xl border border-slate-100">
                                <button className="px-4 py-2 bg-white rounded-xl shadow-sm text-[9px] font-black uppercase tracking-widest text-slate-800">All Nodes</button>
                                <button className="px-4 py-2 text-[9px] font-black uppercase tracking-widest text-slate-400 hover:text-indigo-600 transition-colors">Pending</button>
                            </div>
                        </CardHeader>
